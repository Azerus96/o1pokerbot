...
def start_tournament():
    global tournament  # Важно указать, что мы используем глобальную переменную
    ...
    payout_structure = int(request.form['payouts'])
    ...
    # Настройка и запуск турнира с полученными параметрами
    tournament = setup_tournament(max_players, bot_players, initial_stack, round_duration, payout_structure, allow_late_registration, late_registration_rounds)
